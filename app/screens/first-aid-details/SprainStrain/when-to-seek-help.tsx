...
export default function WhenToSeekHelp() {
  ...
  const transcript = useMemo(() => [
    { word: "Compress", start: 0, end: 0.5, highlight: true },
    { word: "the", start: 0.5, end: 0.7 },
    { word: "area", start: 0.7, end: 1.0 },
    { word: "in", start: 1.0, end: 1.2 },
    { word: "between", start: 1.2, end: 1.5 },
    { word: "icing;", start: 1.5, end: 2.0, highlight: true },
    { word: "Wrap", start: 2.0, end: 2.3, highlight: true },
    { word: "in", start: 2.3, end: 2.5 },
    { word: "an", start: 2.5, end: 2.7 },
    { word: "elastic", start: 2.7, end: 3.0, highlight: true },
    { word: "wrap", start: 3.0, end: 3.3, highlight: true },
    { word: "such", start: 3.3, end: 3.6 },
    { word: "as", start: 3.6, end: 3.8 },
    { word: "an", start: 3.8, end: 4.0 },
    { word: "ace", start: 4.0, end: 4.3, highlight: true },
    { word: "bandage", start: 4.3, end: 4.8, highlight: true },
    { word: "to", start: 4.8, end: 5.0 },
    { word: "combat", start: 5.0, end: 5.4, highlight: true },
    { word: "swelling.", start: 5.4, end: 6.0, highlight: true },
  ], []);
    ...
    >
      ...
      <View style={styles.container}>
        ...
        <ScrollView style={styles.content} showsVerticalScrollIndicator={false}>
          ...
          <View style={styles.videoContainer}>
            <Video
              ref={video}
              style={styles.video}
              source={require("@/assets/videos/sprain-4.mp4")}
              useNativeControls
        ...
        <View style={styles.bottomNav}>
          ...
          <TouchableOpacity 
            style={styles.navButton}
            onPress={() => router.push('/screens/first-aid-details/SprainStrain/rehabilitation')}
          >
