...
export default function RiceMethod() {
  ...
  const transcript = useMemo(() => [
    { word: "Rest", start: 0, end: 0.5, highlight: true },
    { word: "the", start: 0.5, end: 0.7 },
    { word: "injured", start: 0.7, end: 1.1 },
    { word: "body", start: 1.1, end: 1.4 },
    { word: "part;", start: 1.4, end: 1.8 },
    { word: "Lie", start: 2.0, end: 2.3, highlight: true },
    { word: "low", start: 2.3, end: 2.6, highlight: true },
    { word: "for", start: 2.6, end: 2.8 },
    { word: "a", start: 2.8, end: 3.0 },
    { word: "few", start: 3.0, end: 3.2 },
    { word: "days", start: 3.2, end: 3.6 },
    ...
    >
      ...
      <View style={styles.container}>
        ...
        <View style={styles.bottomNav}>
          ...
          <TouchableOpacity 
            style={styles.navButton}
            onPress={() => router.push('/screens/first-aid-details/SprainStrain/pain-management')}
          >
