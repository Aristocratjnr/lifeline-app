...
export default function AbdominalPainsHomeTreatment() {
  const router = useRouter();
  const video = useRef<Video>(null);
  
  // Per-word transcript with timings for abdominal pain home treatment
  const transcript = useMemo(() => [
    { word: "Drinking", start: 0.5, end: 1.0 },
    { word: "plenty", start: 1.0, end: 1.4 },
    { word: "of", start: 1.4, end: 1.6 },
    { word: "fluids", start: 1.6, end: 2.1, highlight: true },
    { word: "such", start: 2.1, end: 2.4 },
    { word: "as", start: 2.4, end: 2.6 },
    { word: "water,", start: 2.6, end: 3.0 },
    { word: "placing", start: 3.2, end: 3.8 },
    { word: "a", start: 3.8, end: 4.0 },
    { word: "hot", start: 4.0, end: 4.3, highlight: true },
    { word: "water", start: 4.3, end: 4.7 },
    { word: "bottle", start: 4.7, end: 5.2, highlight: true },
    { word: "over", start: 5.2, end: 5.5 },
    { word: "the", start: 5.5, end: 5.7 },
    { word: "abdomen.", start: 5.7, end: 6.5 },
    
    { word: "Reducing", start: 7.0, end: 7.6, highlight: true },
    { word: "the", start: 7.6, end: 7.8 },
    { word: "intake", start: 7.8, end: 8.3 },
    { word: "of", start: 8.3, end: 8.5 },
    { word: "coffee,", start: 8.5, end: 9.0, highlight: true },
    { word: "tea,", start: 9.0, end: 9.4, highlight: true },
    { word: "and", start: 9.4, end: 9.7 },
    { word: "alcohol", start: 9.7, end: 10.5, highlight: true }
  ], []);
    ...
    >
      ...
      <View style={styles.container}>
        ...
        <View style={styles.bottomNav}>
          ...
          <TouchableOpacity 
            style={styles.navButton}
            onPress={() => router.push('/screens/first-aid-details/abdominal-pains/when-to-seek-help')}
          >
