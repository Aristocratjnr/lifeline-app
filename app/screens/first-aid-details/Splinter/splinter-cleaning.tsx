...
const SplinterCleaning: React.FC = () => {
  ...
  const transcript = useMemo(() => [
    ...
    { word: "large", start: 0.8, end: 1.2 },
    { word: "splinters,", start: 1.2, end: 1.8 },
    { word: "use", start: 1.8, end: 2.2 },
    { word: "tweezers", start: 2.2, end: 3.0 },
    { word: "cleaned", start: 3.0, end: 3.7 },
    { word: "with", start: 3.7, end: 4.0 },
    { word: "rubbing", start: 4.0, end: 4.7 },
    { word: "alcohol.", start: 4.7, end: 5.5 },
  ], []);

  const [highlightedWordIdx, setHighlightedWordIdx] = useState<number>(-1);

  const handleNext = () => {
    router.push('/screens/first-aid-details/Splinter/splinter-when-to-seek-help');
  };
        ...
        <ScrollView style={styles.content} showsVerticalScrollIndicator={false}>
          ...
          <View style={styles.topVideoContainer}>
            <Video
               ...
               source={require("@/assets/videos/splinter-3.mp4")}
               useNativeControls
...
export default SplinterCleaning;