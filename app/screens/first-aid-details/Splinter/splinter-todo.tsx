...
const CutsInitialAssessment: React.FC = () => {
  ...
  const transcript = useMemo(() => [
    { word: "Wash", start: 0, end: 0.4 },
    { word: "the", start: 0.4, end: 0.6 },
    { word: "area", start: 0.6, end: 0.9 },
    { word: "and", start: 0.9, end: 1.1 },
    { word: "apply", start: 1.1, end: 1.5 },
    { word: "some", start: 1.5, end: 1.7 },
    { word: "antibiotic", start: 1.7, end: 2.4 },
    { word: "ointment", start: 2.4, end: 3.0 },
  ], []);

  const [highlightedWordIdx, setHighlightedWordIdx] = useState<number>(-1);

  const handleNext = () => {
    router.push('/screens/first-aid-details/Splinter/splinter-end');
  };
        ...
        <ScrollView style={styles.content} showsVerticalScrollIndicator={false}>
          ...
          <View style={styles.topVideoContainer}>
            <Video
               ...
               source={require("@/assets/videos/splinter-5.mp4")}
               useNativeControls
